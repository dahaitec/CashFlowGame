...
//  CashFlowGame
//
//  Created by Sheng Zhao Huang on 2019/10/5.
...
class CarController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
       ...
       for index in 0...self.imageArray.count {
        ...
        self.tableView.register(UINib(nibName: "CarTableViewCell", bundle: nil), forCellReuseIdentifier: "cellId")
