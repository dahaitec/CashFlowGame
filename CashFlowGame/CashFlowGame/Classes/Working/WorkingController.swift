...
class WorkingController: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
extension WorkingController {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cellId", for: indexPath) as! WorkingTableViewCell
